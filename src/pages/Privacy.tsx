    ...
    <div className="page">
      ...
      <ul>
        <li>
          ...
          OAuth, we receive your name, email address, and profile picture from
          your Google account.
        </li>
        <li>
          <strong>Usage Data:</strong> We may collect information about how you
          interact with our service, including pages visited and features used.
        </li>
      </ul>
      ...
      <p>
        We use Google OAuth for authentication. By signing in with Google, you
        are also subject to Google's{' '}
        <a
      ...
      <p>
        ...
        service and fulfill the purposes described in this policy. You may
